...
#define YTEditorPluginWWiseDeclareType(Name)                                        \
void Dummy() {}                                                                     \
