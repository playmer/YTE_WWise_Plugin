...
namespace YTEPlugin::WWise
{
  ...
  YTEWWiseDefineType(WWiseListener)
  {
  ...
  void WWiseListener::Initialize()
  {
    ...
    mOwner->RegisterEvent<&WWiseListener::OnPositionChange>(YTE::Events::PositionChanged, this);
    mOwner->RegisterEvent<&WWiseListener::OnOrientationChange>(YTE::Events::OrientationChanged, this);
